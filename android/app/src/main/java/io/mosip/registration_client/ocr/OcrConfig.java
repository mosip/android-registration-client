...
public final class OcrConfig {
    ...
    private static final int DEFAULT_QUALITY_MAX_RETRIES = 30;
    private static final float DEFAULT_BRIGHTNESS_MIN = 40f;
    private static final float DEFAULT_BRIGHTNESS_MAX = 230f;
    private static final double DEFAULT_BLUR_VARIANCE = 90.0;
