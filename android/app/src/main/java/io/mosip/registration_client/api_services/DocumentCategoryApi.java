...
public class DocumentCategoryApi implements DocumentCategoryPigeon.DocumentCategoryApi {
    ...
    private LocalClientCryptoServiceImpl clientCryptoFacade;

    private CryptoManagerService cryptoManagerServiceImpl;
...
//       String certificateData = certificateManagerService.getCertificate(this.globalParamRepository.getCachedResponseSignatureAppId(), this.globalParamRepository.getCachedResponseSignatureRefId());
