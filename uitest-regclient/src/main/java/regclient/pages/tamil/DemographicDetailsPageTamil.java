...
public class DemographicDetailsPageTamil extends DemographicDetailsPage{
	...
	@AndroidFindBy(xpath = "//android.view.View[contains(@content-desc, \"முழு பெயர்\")]/parent::android.view.View/following-sibling::android.view.View/descendant::android.widget.EditText[1]")
	private WebElement fullNameTextBox;

	@AndroidFindBy(xpath = "//android.view.View[contains(@content-desc, \"முழு பெயர்\")]/parent::android.view.View/following-sibling::android.view.View/descendant::android.widget.EditText[2]")
	...
	@AndroidFindBy(xpath = "//android.view.View[contains(@content-desc, \"சிவில் நிலை (திருமண நிலை)\")]/parent::android.view.View/parent::android.widget.Button")
