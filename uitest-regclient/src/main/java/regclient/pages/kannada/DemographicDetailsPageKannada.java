...
public class DemographicDetailsPageKannada extends DemographicDetailsPage{
	...
	@AndroidFindBy(xpath = "//android.view.View[contains(@content-desc, \"ಪೂರ್ಣ ಹೆಸರು\")]/parent::android.view.View/following-sibling::android.view.View/descendant::android.widget.EditText[1]")
	private WebElement fullNameTextBox;

	@AndroidFindBy(xpath = "//android.view.View[contains(@content-desc, \"ಪೂರ್ಣ ಹೆಸರು\")]/parent::android.view.View/following-sibling::android.view.View/descendant::android.widget.EditText[2]")
