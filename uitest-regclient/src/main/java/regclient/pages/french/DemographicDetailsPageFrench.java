...
public class DemographicDetailsPageFrench extends DemographicDetailsPage{
	...
	@AndroidFindBy(xpath = "//android.view.View[contains(@content-desc, \"Nom complet\")]/parent::android.view.View/following-sibling::android.view.View/descendant::android.widget.EditText[1]")
	private WebElement fullNameTextBox;

	@AndroidFindBy(xpath = "//android.view.View[contains(@content-desc, \"Nom complet\")]/parent::android.view.View/following-sibling::android.view.View/descendant::android.widget.EditText[2]")
