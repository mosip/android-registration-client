...
public class ModalityPagerAdapter extends PagerAdapter {
    ...
    public ModalityPagerAdapter(Context context, RegistrationService registrationService, String fieldId) {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        View itemView = inflater.inflate(R.layout.modality_view, container, false);
