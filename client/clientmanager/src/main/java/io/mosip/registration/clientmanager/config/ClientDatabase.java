...
@Database(entities = {UserToken.class, Registration.class, RegistrationCenter.class,
        ...
        BlocklistedWord.class, SyncJobDef.class, UserDetail.class, SyncJobTransaction.class,
        CACertificateStore.class, Language.class},
...
public abstract class ClientDatabase extends RoomDatabase {
    ...
    public abstract SyncJobTransactionDao syncJobTransactionDao();
