...
public class AuditManagerServiceTest {
    ...
    public void audit_test() {
        ...
        assertEquals(AuditEvent.PACKET_AUDIT_JSON_CREATED.getId(), audits.get(0).getEventId());
        assertEquals(AuditEvent.PACKET_AUDIT_JSON_CREATED.getName(), audits.get(0).getEventName());
        assertEquals(AuditEvent.PACKET_AUDIT_JSON_CREATED.getType(), audits.get(0).getEventType());
