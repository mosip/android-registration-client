...
abstract class Demographics {
  ...
  Future<void> addSimpleTypeDemographicField(String fieldId, String value, String language);
  
  Future<void> setDateField(String fieldId, String subType, String day, String month, String year);
