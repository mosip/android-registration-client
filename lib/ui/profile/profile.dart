...
import '../../internet_network_utils/injection.dart';
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  final internetNetworkService = getIt<InternetNetworkService>();

  @override
  void initState() {
    syncProvider = Provider.of<SyncProvider>(context, listen: false);
    internetNetworkService.onConnectivityChanged.listen((result) {
      if (mounted) {
        setState(() {});
      }
    });
  ...
  Future<bool> checkConnection() async {
    return await internetNetworkService.isConnected;
  }
