          ...
          return ListTile(
            ...
            title: Row(
              ...
              children: [
                ...
                SizedBox(width: tableWidth/5.5, child: Text(context.watch<ExportPacketsProvider>().matchingPackets[index-1].id!, textAlign: TextAlign.center,  overflow: TextOverflow.ellipsis,maxLines: 2,)),
