...
mixin _$Field {
  ...
  List<String?>? get bioAttributes => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      controlType: freezed == controlType
          ...
          : controlType // ignore: cast_nullable_to_non_nullable
              as String?,
      bioAttributes: freezed == bioAttributes
          ? _value.bioAttributes
          : bioAttributes // ignore: cast_nullable_to_non_nullable
              as List<String?>?,
...
class _$_Field with DiagnosticableTreeMixin implements _Field {
  const _$_Field(
      ...
      this.controlType,
      final List<String?>? bioAttributes,
      final List<Validator?>? validators,
      final List<RequiredOn?>? requiredOn})
      : _label = label,
        _bioAttributes = bioAttributes,
  ...
  final List<String?>? _bioAttributes;
  @override
  List<String?>? get bioAttributes {
    final value = _bioAttributes;
    if (value == null) return null;
    if (_bioAttributes is EqualUnmodifiableListView) return _bioAttributes;
    // ignore: implicit_dynamic_type
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Field(id: $id, inputRequired: $inputRequired, required: $required, fieldCategory: $fieldCategory, type: $type, minimum: $minimum, maximum: $maximum, description: $description, label: $label, controlType: $controlType, bioAttributes: $bioAttributes, validators: $validators, requiredOn: $requiredOn)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('bioAttributes', bioAttributes))
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._bioAttributes, _bioAttributes) &&
            const DeepCollectionEquality()
  ...
  int get hashCode => Object.hash(
      ...
      controlType,
      const DeepCollectionEquality().hash(_bioAttributes),
