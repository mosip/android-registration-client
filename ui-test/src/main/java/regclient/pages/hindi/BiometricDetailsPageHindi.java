...
public class BiometricDetailsPageHindi extends BiometricDetailsPage {
	...
	@AndroidFindBy(xpath = "//android.widget.EditText[contains(@hint, 'अतिरिक्त जानकारी अनुरोध आईडी')]")
	...
	private static final Logger logger = LoggerFactory.getLogger(BiometricDetailsPageHindi.class);
