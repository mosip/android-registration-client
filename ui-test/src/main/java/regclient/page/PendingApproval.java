...
public abstract class PendingApproval extends BasePage {
	...
	public abstract boolean isInvalidEmptyUsernameSubmitButtonEnabled();

	public abstract boolean isNumberOfApplicationDisplayed();

	public abstract boolean isRejectPacketInfoMessageDisplayed();

	public abstract boolean isPendingApprovalBiometricsInformationDisplayed();

	public abstract void clickOnLatestAid();
	...
	public abstract void clickOnAuthenticateButton();
