...
public class UpdateMyUinMinor extends AndroidBaseTest {
	...
	public void updateMyUinMinor() throws InterruptedException {
		...
		assertTrue(updateUINPage.isInvalidUINErrorMessageDisplayed(),
				"verify if after enter invalid uin it should give error message  ");
		...
		for (String screen : screenOrder) {
			if (screen.equals("consentdet") || screen.equals("consent")) {
				...
				assertTrue(demographicPage.isPageDisplayed("DemographicDetails"),
						"Verify if demographic details page is displayed after clicking disable continue button");
				...
				documentuploadPage.uploadDoccumentsUpdate("minor", "all");
...
//		assertTrue(previewPage.isBiometricsInformationInPreviewPagePageDisplayed(),"Verify if Biometrics Information In PreviewPage is displayed");
		...
		assertTrue(pendingApproval.isRejectButtonDisplayed(), "Verify if  reject button  displayed");
