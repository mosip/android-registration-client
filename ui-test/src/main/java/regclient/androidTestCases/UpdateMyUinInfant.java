	...
	public void updateMyUinInfant() throws InterruptedException {
		...
		for (String screen : screenOrder) {
			if (screen.equals("consentdet") || screen.equals("consent")) {
				...
				assertTrue(applicantBiometricsPage.isFaceScan(), "Verify if iris scan capture popup displayed");
				...
				assertTrue(introducerBiometricPage.isIrisScan(), "Verify if iris scan capture popup displayed");
				...
				documentuploadPage.uploadDoccumentsUpdate("infant", "all");
